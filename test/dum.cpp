...
#define __PYX_HAVE__dum
#define __PYX_HAVE_API__dum
#include <string.h>
#include <stdio.h>
#include <stdlib.h>
...
static PyObject *__pyx_convert_pair_to_py_std_3a__3a_vector_3c_int_3e_______std_3a__3a_vector_3c_std_3a__3a_vector_3c_double_3e____3e___(std::pair<std::vector<int> ,std::vector<std::vector<double> > >  const &); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_double = { "double", NULL, sizeof(double), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "dum"
int __pyx_module_is_main_dum = 0;

/* Implementation of 'dum' */
...
static const char __pyx_k_Users_clareli_Documents_GitHub[] = "/Users/clareli/Documents/GitHub/PymRMRe/test/dum.pyx";
...
static PyObject *__pyx_pf_3dum_compute(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_matrix, double __pyx_v_value); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_3dum_1compute(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_3dum_1compute = {"compute", (PyCFunction)__pyx_pw_3dum_1compute, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_3dum_1compute(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("compute (wrapper)", 0);
  {
    ...
    __pyx_v_value = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_value == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 17, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("compute", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 17, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("dum.compute", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_matrix), __pyx_ptype_5numpy_ndarray, 1, "matrix", 0))) __PYX_ERR(0, 17, __pyx_L1_error)
  __pyx_r = __pyx_pf_3dum_compute(__pyx_self, __pyx_v_matrix, __pyx_v_value);
...
static PyObject *__pyx_pf_3dum_compute(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_matrix, double __pyx_v_value) {
  int __pyx_v_m;
  int __pyx_v_n;
  std::pair<std::vector<int> ,std::vector<std::vector<double> > >  __pyx_v_res;
  ...
  __pyx_pybuffernd_matrix.rcbuffer = &__pyx_pybuffer_matrix;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_matrix.rcbuffer->pybuffer, (PyObject*)__pyx_v_matrix, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 17, __pyx_L1_error)
  }
 ...
 * 
 */
  __pyx_t_1 = __Pyx_div_long((__pyx_v_matrix->dimensions[0]), 2);
  __pyx_t_2 = 2;
  __pyx_v_m = __pyx_t_1;
  __pyx_v_n = __pyx_t_2;
 ...
 */
  __pyx_t_3 = 0;
  __pyx_v_res = c_compute((&(*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_matrix.rcbuffer->pybuffer.buf, __pyx_t_3, __pyx_pybuffernd_matrix.diminfo[0].strides))), __pyx_v_value, __pyx_v_m, __pyx_v_n);
 ...
 */
  ...
  __pyx_t_4 = __pyx_convert_pair_to_py_std_3a__3a_vector_3c_int_3e_______std_3a__3a_vector_3c_std_3a__3a_vector_3c_double_3e____3e___(__pyx_v_res); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 22, __pyx_L1_error)
...
/* "pair.to_py":180
 * 
 * @cname("__pyx_convert_pair_to_py_std_3a__3a_vector_3c_int_3e_______std_3a__3a_vector_3c_std_3a__3a_vector_3c_double_3e____3e___")
 * cdef object __pyx_convert_pair_to_py_std_3a__3a_vector_3c_int_3e_______std_3a__3a_vector_3c_std_3a__3a_vector_3c_double_3e____3e___(const pair[X,Y]& p):             # <<<<<<<<<<<<<<
 *     return X_to_py(p.first), Y_to_py(p.second)
 * 
 */

static PyObject *__pyx_convert_pair_to_py_std_3a__3a_vector_3c_int_3e_______std_3a__3a_vector_3c_std_3a__3a_vector_3c_double_3e____3e___(std::pair<std::vector<int> ,std::vector<std::vector<double> > >  const &__pyx_v_p) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  PyObject *__pyx_t_3 = NULL;
  __Pyx_RefNannySetupContext("__pyx_convert_pair_to_py_std_3a__3a_vector_3c_int_3e_______std_3a__3a_vector_3c_std_3a__3a_vector_3c_double_3e____3e___", 0);
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_convert_vector_to_py_int(__pyx_v_p.first); if (unlikely(!__pyx_t_1)) __PYX_ERR(2, 181, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __pyx_convert_vector_to_py_std_3a__3a_vector_3c_double_3e___(__pyx_v_p.second); if (unlikely(!__pyx_t_2)) __PYX_ERR(2, 181, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_AddTraceback("pair.to_py.__pyx_convert_pair_to_py_std_3a__3a_vector_3c_int_3e_______std_3a__3a_vector_3c_std_3a__3a_vector_3c_double_3e____3e___", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
 ...
 *     m, n = matrix.shape[0] / 2, 2
 */
  __pyx_tuple__10 = PyTuple_Pack(5, __pyx_n_s_matrix, __pyx_n_s_value, __pyx_n_s_m, __pyx_n_s_n, __pyx_n_s_res); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(2, 0, 5, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_clareli_Documents_GitHub, __pyx_n_s_compute, 17, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initdum(void); /*proto*/
PyMODINIT_FUNC initdum(void)
#else
PyMODINIT_FUNC PyInit_dum(void); /*proto*/
PyMODINIT_FUNC PyInit_dum(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_t_2;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_dum(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("dum", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_dum) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "dum")) {
      if (unlikely(PyDict_SetItemString(modules, "dum", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     m, n = matrix.shape[0] / 2, 2
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_3dum_1compute, NULL, __pyx_n_s_dum); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_compute, __pyx_t_1) < 0) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init dum", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init dum");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
