...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "/anaconda/lib/python3.6/site-packages/numpy/core/include/numpy/arrayobject.h",
            "/anaconda/lib/python3.6/site-packages/numpy/core/include/numpy/ufuncobject.h",
            "exports.cpp"
        ],
        "extra_compile_args": [
            "-stdlib=libc++"
...
static const char __pyx_k_Users_clareli_Documents_GitHub[] = "/Users/clareli/Documents/GitHub/PymRMRe/src/expt.pyx";
...
static PyObject *__pyx_kp_s_Users_clareli_Documents_GitHub;
...
static PyMethodDef __pyx_mdef_4expt_1export_filters = {"export_filters", (PyCFunction)__pyx_pw_4expt_1export_filters, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_4expt_1export_filters(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_childrenCountPerLevel,&__pyx_n_s_dataMatrix,&__pyx_n_s_priorsMatrix,&__pyx_n_s_priorsWeight,&__pyx_n_s_sampleStrata,&__pyx_n_s_sampleWeights,&__pyx_n_s_featureTypes,&__pyx_n_s_sampleCount,&__pyx_n_s_featureCount,&__pyx_n_s_sampleStratumCount,&__pyx_n_s_targetFeatureIndices,&__pyx_n_s_continuousEstimator,&__pyx_n_s_outX,&__pyx_n_s_bootstrapCount,&__pyx_n_s_miMatrix,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_childrenCountPerLevel)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_dataMatrix)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("export_filters", 1, 15, 15, 1); __PYX_ERR(0, 48, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_priorsMatrix)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("export_filters", 1, 15, 15, 2); __PYX_ERR(0, 48, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_priorsWeight)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("export_filters", 1, 15, 15, 3); __PYX_ERR(0, 48, __pyx_L3_error)
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_sampleStrata)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("export_filters", 1, 15, 15, 4); __PYX_ERR(0, 48, __pyx_L3_error)
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_sampleWeights)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("export_filters", 1, 15, 15, 5); __PYX_ERR(0, 48, __pyx_L3_error)
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_featureTypes)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("export_filters", 1, 15, 15, 6); __PYX_ERR(0, 48, __pyx_L3_error)
        }
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_sampleCount)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("export_filters", 1, 15, 15, 7); __PYX_ERR(0, 48, __pyx_L3_error)
        }
        case  8:
        if (likely((values[8] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_featureCount)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("export_filters", 1, 15, 15, 8); __PYX_ERR(0, 48, __pyx_L3_error)
        }
        case  9:
        if (likely((values[9] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_sampleStratumCount)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("export_filters", 1, 15, 15, 9); __PYX_ERR(0, 48, __pyx_L3_error)
        }
        case 10:
        if (likely((values[10] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_targetFeatureIndices)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("export_filters", 1, 15, 15, 10); __PYX_ERR(0, 48, __pyx_L3_error)
        }
        case 11:
        if (likely((values[11] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_continuousEstimator)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("export_filters", 1, 15, 15, 11); __PYX_ERR(0, 48, __pyx_L3_error)
        }
        case 12:
        if (likely((values[12] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_outX)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("export_filters", 1, 15, 15, 12); __PYX_ERR(0, 48, __pyx_L3_error)
        }
        case 13:
        if (likely((values[13] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_bootstrapCount)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("export_filters", 1, 15, 15, 13); __PYX_ERR(0, 48, __pyx_L3_error)
        }
        case 14:
        if (likely((values[14] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_miMatrix)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("export_filters", 1, 15, 15, 14); __PYX_ERR(0, 48, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "export_filters") < 0)) __PYX_ERR(0, 48, __pyx_L3_error)
      }
    ...
    __pyx_v_dataMatrix = ((PyArrayObject *)values[1]);
    __pyx_v_priorsMatrix = ((PyArrayObject *)values[2]);
    __pyx_v_priorsWeight = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_priorsWeight == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 51, __pyx_L3_error)
    __pyx_v_sampleStrata = ((PyArrayObject *)values[4]);
    __pyx_v_sampleWeights = ((PyArrayObject *)values[5]);
    __pyx_v_featureTypes = ((PyArrayObject *)values[6]);
    __pyx_v_sampleCount = __Pyx_PyInt_As_int(values[7]); if (unlikely((__pyx_v_sampleCount == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 55, __pyx_L3_error)
    __pyx_v_featureCount = __Pyx_PyInt_As_int(values[8]); if (unlikely((__pyx_v_featureCount == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 56, __pyx_L3_error)
    __pyx_v_sampleStratumCount = __Pyx_PyInt_As_int(values[9]); if (unlikely((__pyx_v_sampleStratumCount == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 57, __pyx_L3_error)
    __pyx_v_targetFeatureIndices = ((PyArrayObject *)values[10]);
    __pyx_v_continuousEstimator = __Pyx_PyInt_As_int(values[11]); if (unlikely((__pyx_v_continuousEstimator == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 59, __pyx_L3_error)
    __pyx_v_outX = __Pyx_PyInt_As_int(values[12]); if (unlikely((__pyx_v_outX == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 60, __pyx_L3_error)
    __pyx_v_bootstrapCount = __Pyx_PyInt_As_int(values[13]); if (unlikely((__pyx_v_bootstrapCount == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 61, __pyx_L3_error)
    __pyx_v_miMatrix = ((PyArrayObject *)values[14]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("export_filters", 1, 15, 15, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 48, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("expt.export_filters", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_childrenCountPerLevel), __pyx_ptype_5numpy_ndarray, 1, "childrenCountPerLevel", 0))) __PYX_ERR(0, 48, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_dataMatrix), __pyx_ptype_5numpy_ndarray, 1, "dataMatrix", 0))) __PYX_ERR(0, 49, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_priorsMatrix), __pyx_ptype_5numpy_ndarray, 1, "priorsMatrix", 0))) __PYX_ERR(0, 50, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_sampleStrata), __pyx_ptype_5numpy_ndarray, 1, "sampleStrata", 0))) __PYX_ERR(0, 52, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_sampleWeights), __pyx_ptype_5numpy_ndarray, 1, "sampleWeights", 0))) __PYX_ERR(0, 53, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_featureTypes), __pyx_ptype_5numpy_ndarray, 1, "featureTypes", 0))) __PYX_ERR(0, 54, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_targetFeatureIndices), __pyx_ptype_5numpy_ndarray, 1, "targetFeatureIndices", 0))) __PYX_ERR(0, 58, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_miMatrix), __pyx_ptype_5numpy_ndarray, 1, "miMatrix", 0))) __PYX_ERR(0, 62, __pyx_L1_error)
  __pyx_r = __pyx_pf_4expt_export_filters(__pyx_self, __pyx_v_childrenCountPerLevel, __pyx_v_dataMatrix, __pyx_v_priorsMatrix, __pyx_v_priorsWeight, __pyx_v_sampleStrata, __pyx_v_sampleWeights, __pyx_v_featureTypes, __pyx_v_sampleCount, __pyx_v_featureCount, __pyx_v_sampleStratumCount, __pyx_v_targetFeatureIndices, __pyx_v_continuousEstimator, __pyx_v_outX, __pyx_v_bootstrapCount, __pyx_v_miMatrix);
...
static PyObject *__pyx_pf_4expt_export_filters(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_childrenCountPerLevel, PyArrayObject *__pyx_v_dataMatrix, PyArrayObject *__pyx_v_priorsMatrix, double __pyx_v_priorsWeight, PyArrayObject *__pyx_v_sampleStrata, PyArrayObject *__pyx_v_sampleWeights, PyArrayObject *__pyx_v_featureTypes, int __pyx_v_sampleCount, int __pyx_v_featureCount, int __pyx_v_sampleStratumCount, PyArrayObject *__pyx_v_targetFeatureIndices, int __pyx_v_continuousEstimator, int __pyx_v_outX, int __pyx_v_bootstrapCount, PyArrayObject *__pyx_v_miMatrix) {
  ...
  __pyx_pybuffernd_miMatrix.rcbuffer = &__pyx_pybuffer_miMatrix;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_childrenCountPerLevel.rcbuffer->pybuffer, (PyObject*)__pyx_v_childrenCountPerLevel, &__Pyx_TypeInfo_int, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 48, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_dataMatrix.rcbuffer->pybuffer, (PyObject*)__pyx_v_dataMatrix, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 48, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_priorsMatrix.rcbuffer->pybuffer, (PyObject*)__pyx_v_priorsMatrix, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 48, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_sampleStrata.rcbuffer->pybuffer, (PyObject*)__pyx_v_sampleStrata, &__Pyx_TypeInfo_int, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 48, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_sampleWeights.rcbuffer->pybuffer, (PyObject*)__pyx_v_sampleWeights, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 48, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_featureTypes.rcbuffer->pybuffer, (PyObject*)__pyx_v_featureTypes, &__Pyx_TypeInfo_int, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 48, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_targetFeatureIndices.rcbuffer->pybuffer, (PyObject*)__pyx_v_targetFeatureIndices, &__Pyx_TypeInfo_unsigned_int, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 48, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_miMatrix.rcbuffer->pybuffer, (PyObject*)__pyx_v_miMatrix, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 48, __pyx_L1_error)
  }
 ...
 */
  ...
  __pyx_t_9 = __pyx_convert_pair_to_py_std_3a__3a_vector_3c_std_3a__3a_vector_3c_int_3e____3e_______std_3a__3a_vector_3c_std_3a__3a_vector_3c_std_3a__3a_vector_3c_double_3e____3e____3e___(__pyx_v_res); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 69, __pyx_L1_error)
...
static PyMethodDef __pyx_mdef_4expt_3export_mim = {"export_mim", (PyCFunction)__pyx_pw_4expt_3export_mim, METH_VARARGS|METH_KEYWORDS, 0};
  ...
  __Pyx_RefNannySetupContext("export_mim (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_priorsMatrix)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("export_mim", 1, 13, 13, 1); __PYX_ERR(0, 71, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_priorsWeight)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("export_mim", 1, 13, 13, 2); __PYX_ERR(0, 71, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_sampleStrata)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("export_mim", 1, 13, 13, 3); __PYX_ERR(0, 71, __pyx_L3_error)
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_sampleWeights)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("export_mim", 1, 13, 13, 4); __PYX_ERR(0, 71, __pyx_L3_error)
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_featureTypes)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("export_mim", 1, 13, 13, 5); __PYX_ERR(0, 71, __pyx_L3_error)
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_sampleCount)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("export_mim", 1, 13, 13, 6); __PYX_ERR(0, 71, __pyx_L3_error)
        }
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_featureCount)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("export_mim", 1, 13, 13, 7); __PYX_ERR(0, 71, __pyx_L3_error)
        }
        case  8:
        if (likely((values[8] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_sampleStratumCount)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("export_mim", 1, 13, 13, 8); __PYX_ERR(0, 71, __pyx_L3_error)
        }
        case  9:
        if (likely((values[9] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_continuousEstimator)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("export_mim", 1, 13, 13, 9); __PYX_ERR(0, 71, __pyx_L3_error)
        }
        case 10:
        if (likely((values[10] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_outX)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("export_mim", 1, 13, 13, 10); __PYX_ERR(0, 71, __pyx_L3_error)
        }
        case 11:
        if (likely((values[11] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_bootstrapCount)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("export_mim", 1, 13, 13, 11); __PYX_ERR(0, 71, __pyx_L3_error)
        }
        case 12:
        if (likely((values[12] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_miMatrix)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("export_mim", 1, 13, 13, 12); __PYX_ERR(0, 71, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "export_mim") < 0)) __PYX_ERR(0, 71, __pyx_L3_error)
      }
    ...
    __pyx_v_priorsWeight = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_priorsWeight == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 73, __pyx_L3_error)
    ...
    __pyx_v_sampleCount = __Pyx_PyInt_As_int(values[6]); if (unlikely((__pyx_v_sampleCount == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 77, __pyx_L3_error)
    __pyx_v_featureCount = __Pyx_PyInt_As_int(values[7]); if (unlikely((__pyx_v_featureCount == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 78, __pyx_L3_error)
    __pyx_v_sampleStratumCount = __Pyx_PyInt_As_int(values[8]); if (unlikely((__pyx_v_sampleStratumCount == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 79, __pyx_L3_error)
    __pyx_v_continuousEstimator = __Pyx_PyInt_As_int(values[9]); if (unlikely((__pyx_v_continuousEstimator == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 80, __pyx_L3_error)
    __pyx_v_outX = __Pyx_PyInt_As_int(values[10]); if (unlikely((__pyx_v_outX == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 81, __pyx_L3_error)
    __pyx_v_bootstrapCount = __Pyx_PyInt_As_int(values[11]); if (unlikely((__pyx_v_bootstrapCount == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 82, __pyx_L3_error)
    __pyx_v_miMatrix = ((PyArrayObject *)values[12]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("export_mim", 1, 13, 13, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 71, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("expt.export_mim", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_dataMatrix), __pyx_ptype_5numpy_ndarray, 1, "dataMatrix", 0))) __PYX_ERR(0, 71, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_priorsMatrix), __pyx_ptype_5numpy_ndarray, 1, "priorsMatrix", 0))) __PYX_ERR(0, 72, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_sampleStrata), __pyx_ptype_5numpy_ndarray, 1, "sampleStrata", 0))) __PYX_ERR(0, 74, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_sampleWeights), __pyx_ptype_5numpy_ndarray, 1, "sampleWeights", 0))) __PYX_ERR(0, 75, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_featureTypes), __pyx_ptype_5numpy_ndarray, 1, "featureTypes", 0))) __PYX_ERR(0, 76, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_miMatrix), __pyx_ptype_5numpy_ndarray, 1, "miMatrix", 0))) __PYX_ERR(0, 83, __pyx_L1_error)
...
static PyObject *__pyx_pf_4expt_2export_mim(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_dataMatrix, PyArrayObject *__pyx_v_priorsMatrix, double __pyx_v_priorsWeight, PyArrayObject *__pyx_v_sampleStrata, PyArrayObject *__pyx_v_sampleWeights, PyArrayObject *__pyx_v_featureTypes, int __pyx_v_sampleCount, int __pyx_v_featureCount, int __pyx_v_sampleStratumCount, int __pyx_v_continuousEstimator, int __pyx_v_outX, int __pyx_v_bootstrapCount, PyArrayObject *__pyx_v_miMatrix) {
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_dataMatrix.rcbuffer->pybuffer, (PyObject*)__pyx_v_dataMatrix, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 71, __pyx_L1_error)
  }
  __pyx_pybuffernd_dataMatrix.diminfo[0].strides = __pyx_pybuffernd_dataMatrix.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_dataMatrix.diminfo[0].shape = __pyx_pybuffernd_dataMatrix.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_priorsMatrix.rcbuffer->pybuffer, (PyObject*)__pyx_v_priorsMatrix, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 71, __pyx_L1_error)
  }
  __pyx_pybuffernd_priorsMatrix.diminfo[0].strides = __pyx_pybuffernd_priorsMatrix.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_priorsMatrix.diminfo[0].shape = __pyx_pybuffernd_priorsMatrix.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_sampleStrata.rcbuffer->pybuffer, (PyObject*)__pyx_v_sampleStrata, &__Pyx_TypeInfo_int, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 71, __pyx_L1_error)
  }
  __pyx_pybuffernd_sampleStrata.diminfo[0].strides = __pyx_pybuffernd_sampleStrata.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_sampleStrata.diminfo[0].shape = __pyx_pybuffernd_sampleStrata.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_sampleWeights.rcbuffer->pybuffer, (PyObject*)__pyx_v_sampleWeights, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 71, __pyx_L1_error)
  }
  __pyx_pybuffernd_sampleWeights.diminfo[0].strides = __pyx_pybuffernd_sampleWeights.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_sampleWeights.diminfo[0].shape = __pyx_pybuffernd_sampleWeights.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_featureTypes.rcbuffer->pybuffer, (PyObject*)__pyx_v_featureTypes, &__Pyx_TypeInfo_int, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 71, __pyx_L1_error)
  }
  __pyx_pybuffernd_featureTypes.diminfo[0].strides = __pyx_pybuffernd_featureTypes.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_featureTypes.diminfo[0].shape = __pyx_pybuffernd_featureTypes.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_miMatrix.rcbuffer->pybuffer, (PyObject*)__pyx_v_miMatrix, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 71, __pyx_L1_error)
  }
  __pyx_pybuffernd_miMatrix.diminfo[0].strides = __pyx_pybuffernd_miMatrix.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_miMatrix.diminfo[0].shape = __pyx_pybuffernd_miMatrix.rcbuffer->pybuffer.shape[0];
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;
    __pyx_t_4 = __pyx_convert_vector_to_py_std_3a__3a_vector_3c_double_3e___((__pyx_v_v[__pyx_v_i])); if (unlikely(!__pyx_t_4)) __PYX_ERR(2, 68, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    if (unlikely(__Pyx_ListComp_Append(__pyx_t_1, (PyObject*)__pyx_t_4))) __PYX_ERR(2, 68, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  }
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_convert_vector_to_py_std_3a__3a_vector_3c_int_3e___(__pyx_v_p.first); if (unlikely(!__pyx_t_1)) __PYX_ERR(2, 181, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __pyx_convert_vector_to_py_std_3a__3a_vector_3c_std_3a__3a_vector_3c_double_3e____3e___(__pyx_v_p.second); if (unlikely(!__pyx_t_2)) __PYX_ERR(2, 181, __pyx_L1_error)
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_Users_clareli_Documents_GitHub, __pyx_k_Users_clareli_Documents_GitHub, sizeof(__pyx_k_Users_clareli_Documents_GitHub), 0, 0, 1, 0},
 ...
 *                     np.ndarray[double, ndim = 1, mode = "c"] priorsMatrix,
 */
  __pyx_tuple__10 = PyTuple_Pack(16, __pyx_n_s_childrenCountPerLevel, __pyx_n_s_dataMatrix, __pyx_n_s_priorsMatrix, __pyx_n_s_priorsWeight, __pyx_n_s_sampleStrata, __pyx_n_s_sampleWeights, __pyx_n_s_featureTypes, __pyx_n_s_sampleCount, __pyx_n_s_featureCount, __pyx_n_s_sampleStratumCount, __pyx_n_s_targetFeatureIndices, __pyx_n_s_continuousEstimator, __pyx_n_s_outX, __pyx_n_s_bootstrapCount, __pyx_n_s_miMatrix, __pyx_n_s_res); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(15, 0, 16, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_clareli_Documents_GitHub, __pyx_n_s_export_filters, 48, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 48, __pyx_L1_error)
 ...
 *                 double priorsWeight,
 */
  __pyx_tuple__12 = PyTuple_Pack(13, __pyx_n_s_dataMatrix, __pyx_n_s_priorsMatrix, __pyx_n_s_priorsWeight, __pyx_n_s_sampleStrata, __pyx_n_s_sampleWeights, __pyx_n_s_featureTypes, __pyx_n_s_sampleCount, __pyx_n_s_featureCount, __pyx_n_s_sampleStratumCount, __pyx_n_s_continuousEstimator, __pyx_n_s_outX, __pyx_n_s_bootstrapCount, __pyx_n_s_miMatrix); if (unlikely(!__pyx_tuple__12)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__12);
  __Pyx_GIVEREF(__pyx_tuple__12);
  __pyx_codeobj__13 = (PyObject*)__Pyx_PyCode_New(13, 0, 13, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__12, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_clareli_Documents_GitHub, __pyx_n_s_export_mim, 71, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__13)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initexpt(void); /*proto*/
PyMODINIT_FUNC initexpt(void)
#else
PyMODINIT_FUNC PyInit_expt(void); /*proto*/
PyMODINIT_FUNC PyInit_expt(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_t_2;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_expt(void)", 0);
 ...
 */
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_version, __pyx_kp_s_1_0_0) < 0) __PYX_ERR(0, 12, __pyx_L1_error)
 ...
 *                     np.ndarray[double, ndim = 1, mode = "c"] priorsMatrix,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4expt_1export_filters, NULL, __pyx_n_s_expt); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_export_filters, __pyx_t_1) < 0) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *                 double priorsWeight,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4expt_3export_mim, NULL, __pyx_n_s_expt); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_export_mim, __pyx_t_1) < 0) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
